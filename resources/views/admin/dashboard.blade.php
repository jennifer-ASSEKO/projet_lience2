...
<!-- Mirrored from demo.bootstrapdash.com/celestial/template/demo/vertical-default-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Dec 2024 15:27:51 GMT -->
...
<head>
    ...
    <!-- base:css -->
    <link rel="stylesheet" href="{{ asset('templates/template1/vendors/typicons.font/font/typicons.css') }}">
    <link rel="stylesheet" href="{{ asset('templates/template1/vendors/css/vendor.bundle.base.css') }}">
    <!-- endinject -->
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{ asset('templates/template1/css/vertical-layout-light/style.css') }}">
    <!-- endinject -->
    <link rel="shortcut icon" href="{{ asset('templates/template1/images/favicon.png') }}" />
</head>
...
<body>
                ...
                <div class="card-body card-body-padding px-3 d-flex align-items-center justify-content-between">
                    <div class="ps-lg-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="https://www.bootstrapdash.com/product/celestial-admin-template/" target="_blank"
                                class="btn me-2 buy-now-btn border-0">Buy Now</a>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="https://www.bootstrapdash.com/product/celestial-admin-template/"><i
                                class="typcn typcn-home me-3 text-white"></i></a>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="index.html"><img
                        src="{{ asset('templates/template1/images/logo.svg') }}" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img
                        src="{{ asset('templates/template1/images/logo-mini.svg') }}" alt="logo" /></a>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <ul class="navbar-nav navbar-nav-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('templates/template1/images/faces/face4.jpg') }}" alt="image"
                                        class="profile-pic">
                                </div>
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('templates/template1/images/faces/face2.jpg') }}" alt="image"
                                        class="profile-pic">
                                </div>
                                <div class="preview-item-content flex-grow">
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('templates/template1/images/faces/face3.jpg') }}" alt="image"
                                        class="profile-pic">
                                </div>
                                <div class="preview-item-content flex-grow">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle  pl-0 pr-0" href="#" data-bs-toggle="dropdown"
                            id="profileDropdown">
                    ...
                    <li class="nav-item">
                        <div class="d-flex sidebar-profile">
                            <div class="sidebar-profile-image">
                                <img src="{{ asset('templates/template1/images/faces/face29.png') }}" alt="image">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html">
                            ...
                            <span class="menu-title">Dashboard <span
                                    class="badge badge-primary ms-3">New</span></span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/ui-features/notifications.html">
                            ...
                            <span class="menu-title">Notifications <span
                                    class="badge badge-info badge-pill ms-3">2</span></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="pages/icons/themify.html">Themify
                                        icons</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="pages/icons/typicons.html">Typicons</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="pages/samples/mutli-level-login.html"> Multi Step Login </a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/apps/calendar.html">
                            ...
                            <span class="menu-title">Calendar <span
                                    class="badge badge-warning ms-3 text-white">New</span></span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="main-panel">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center justify-content-md-end">
                                <div class="mb-3 mb-xl-0 pr-1">
                                    <div class="dropdown">
                                        <button class="btn bg-white btn-sm dropdown-toggle btn-icon-text border me-2"
                                            type="button" id="dropdownMenu3" data-bs-toggle="dropdown"
                                ...
                                <div class="pr-1 mb-3 me-2 mb-xl-0">
                                    <button type="button" class="btn btn-sm bg-white btn-icon-text border"><i
                                            class="typcn typcn-arrow-forward-outline me-2"></i>Export</button>
                                </div>
                                <div class="pr-1 mb-3 mb-xl-0">
                                    <button type="button" class="btn btn-sm bg-white btn-icon-text border"><i
                                            class="typcn typcn-info-large-outline me-2"></i>info</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div id="circleProgress6"
                                                        class="progressbar-js-circle rounded p-3"></div>
                                                </div>
                                                <div class="col-lg-6">
                                        ...
                                        <div class="col-12">
                                            <div class="d-md-flex mb-4">
                                                <div class="me-md-5 mb-4">
                                                    <h5 class="mb-1"><i
                                                            class="typcn typcn-globe-outline me-1"></i>Online</h5>
                                                    <h2 class="text-primary mb-1 font-weight-bold">23,342</h2>
                                                </div>
                                                <div class="me-md-5 mb-4">
                                                    <h5 class="mb-1"><i class="typcn typcn-archive me-1"></i>Offline
                                                    </h5>
                                                    <h2 class="text-secondary mb-1 font-weight-bold">13,221</h2>
                                                </div>
                                                <div class="me-md-5 mb-4">
                                                    <h5 class="mb-1"><i class="typcn typcn-tags me-1"></i>Marketing
                                                    </h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="d-sm-flex justify-content-between">
                                                <div class="dropdown">
                                                    <button
                                                        class="btn bg-white btn-sm dropdown-toggle btn-icon-text pl-0"
                                                ...
                                                <div>
                                                    <button type="button"
                                                        class="btn btn-sm btn-light me-2">Day</button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-light me-2">Week</button>
                                                    <button type="button" class="btn btn-sm btn-light">Month</button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mt-4 mb-5">
                                        ...
                                        <div class="progress progress-md mt-2">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                style="width: 70%" aria-valuenow="90" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <img class="img-sm rounded-circle mb-md-0 me-2"
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023 <a
                                href="https://www.bootstrapdash.com/" target="_blank">Bootstrapdash</a>. All rights
                            reserved.</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made
                            with <i class="typcn typcn-heart text-danger"></i></span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
    ...
    <!-- container-scroller -->
    <!-- base:js -->
    <script src="{{ asset('templates/template1/vendors/js/vendor.bundle.base.js') }}"></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src="{{ asset('templates/template1/js/off-canvas.js') }}"></script>
    <script src="{{ asset('templates/template1/js/hoverable-collapse.js') }}"></script>
    <script src="{{ asset('templates/template1/js/template.js') }}"></script>
    <script src="{{ asset('templates/template1/js/settings.js') }}"></script>
    <script src="{{ asset('templates/template1/js/todolist.js') }}"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="{{ asset('templates/template1/vendors/progressbar.js/progressbar.min.js') }}"></script>
    <script src="{{ asset('templates/template1/vendors/chart.js/Chart.min.js') }}"></script>
    <script src="{{ asset('templates/template1/js/jquery.cookie.js') }}" type="text/javascript"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="{{ asset('templates/template1/js/dashboard.js') }}"></script>
    <!-- End custom js for this page-->
</body>

<!-- Mirrored from demo.bootstrapdash.com/celestial/template/demo/vertical-default-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Dec 2024 15:28:17 GMT -->
